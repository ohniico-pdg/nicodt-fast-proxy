...
def claude_search():
    ...
    # Prompt système expert pour recherche événementielle
    system = """Tu es un expert en recherche d'événements culturels et musicaux en France.
Ta mission : trouver des dates de spectacles/concerts RÉELS et VÉRIFIÉS sur internet.

RÈGLES STRICTES :
- Cherche UNIQUEMENT des dates futures ou récentes (2025-2026)
- Vérifie sur PLUSIEURS sources : fnacspectacles.com, ticketmaster.fr, livenation.fr, songkick.com, infoconcert.com, le site officiel de l'artiste
- N'invente JAMAIS une date — si tu n'es pas sûr, mets score_fiabilite: "faible"
- Retourne UNIQUEMENT un tableau JSON valide, sans texte avant ou après
- Si aucune date trouvée : retourne exactement []

FORMAT DE RÉPONSE : tableau JSON uniquement, commençant par [ et finissant par ]"""

    # Prompt utilisateur enrichi avec instructions de recherche multi-sources
    enriched_prompt = f"""TÂCHE : {prompt}

INSTRUCTIONS DE RECHERCHE :
1. Cherche d'abord sur fnacspectacles.com et ticketmaster.fr
2. Cherche ensuite sur le site officiel de l'artiste et ses réseaux sociaux
3. Cherche sur songkick.com et infoconcert.com
4. Pour chaque date trouvée, vérifie qu'elle est bien réelle en croisant au moins 2 sources
5. Note l'URL exacte de la page où tu as trouvé la date dans le champ "source"
6. Si tu trouves des tournées, note le nom dans "tournee"

IMPORTANT : dates 2025-2026 uniquement. Retourne [] si rien trouvé."""
