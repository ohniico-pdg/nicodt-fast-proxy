...
Artiste bien connu — cherche UNIQUEMENT les nouvelles dates non encore mémorisées.
...
Extrait TOUTES les dates 2025-2026 avec salle, jauge, prix, URL.
Résultats DÉDUPLIQUÉS triés par date. JSON uniquement : {EVENT_SCHEMA}"""
    else:
        prompt1 = f"""{context}

Recherche : "{artiste} humoriste site officiel dates spectacle 2026"
1. Trouve son site officiel
2. Va sur sa page dates/tournée
3. Extrait TOUTES les dates 2025-2026
...
{sites_str}
Filtres : {filtres or "aucun"}
Salle exacte, jauge, prix, URL. Uniquement 2025-2026.
