...
def search():
    ...
    site_artiste_input = data.get("site_artiste", "").strip()
    ...
    # Priorité : saisie utilisateur > mémoire > variantes auto
    site_url = site_artiste_input or mem.get("site")
    if site_artiste_input and site_artiste_input != mem.get("site"):
        # Sauvegarde immédiate du site artiste fourni par l'utilisateur
        save_artist_memory(artiste, {"site": site_artiste_input})
    if site_url:
