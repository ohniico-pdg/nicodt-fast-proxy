...
Réponds UNIQUEMENT avec ce JSON : {EVENT_SCHEMA}"""
    ...
    # ══════════════════════════════════════════════════════════
    # PHASE 2 — Instagram + bio links (Linktree etc.)
    # ══════════════════════════════════════════════════════════
    if ig_input:
        ig_variants = [f"https://www.instagram.com/{ig_input}/"]
    elif mem.get("instagram"):
        ig_variants = [mem.get("instagram")]
    else:
        ig_variants = guess_instagram_variants(artiste)
